...
bash ./gradlew --configure-on-demand --parallel --offline --max-workers=`cat /proc/cpuinfo | grep processor | wc -l` assembleRelease  -PstatisticsDataUploadcount=1 -PsensorDataConfig=1
